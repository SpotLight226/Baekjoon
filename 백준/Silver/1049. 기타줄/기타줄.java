...
public class Main {
	...
	public static void main(String args[]) throws IOException {
		...
		int M = Integer.parseInt(st.nextToken()); //브랜드 개수
       	...
       	//세트 가격, 낱개 가격 초기화는 1000 (가격은 1000보다 작거나 같을 수 있다)
		...
		for(int i=0; i<M; i++) {
            ...
            //기타 세트 가격 중 최소값
			min_set_price = Math.min(min_set_price,Integer.parseInt(st.nextToken())); 
            //기타 낱개 가격 중 최소값
			min_unit_price = Math.min(min_unit_price,Integer.parseInt(st.nextToken()));
		}
